        ...
        times with other food lovers. */}
            ...
            {LangInUse === "Ita" && (
              <>
                ...
                cucinare piatti italiani, socializzano e condividono divertenti
        ...
        preferences. */}
            ...
            {LangInUse === "Esp" && (
              <>
                ...
                permitiéndote elegir el menú y el ritmo según tus preferencias.
              </>
            )}
            {LangInUse === "Ita" && (
              <>
                Le lezioni di cucina private con un{"'"}attenzione
                personalizzata, permettendoti di scegliere il menu e il ritmo in
...
export default SubHeroTripletMD;
