            ...
            <>
              <Col className="col-12 col-lg-9 col-xxl-7 d-flex flex-column d-flex justify-content-center">
                ...
                <div className="ls-1">
                  ...
                  experiences in Spain and Argentina. All of this is served with
                  a touch of elegance, in the comfort of your home. I have been
                  fortunate to work in various places, from Italy to Ireland and
                  Spain. I trained at the Escuela de Hosteleria de Sevilla, one
                  of the best in Spain, and I have had the privilege of learning
                  from renowned chefs such as Rafa Zafra, Ricardo Acquista, and
                  Gonzalo Villalba. I have also been collaborating with Pasta
                  Garófalo Spain, creating recipes and videos for the past two
                  years, having made over 150 video-recipes. I am thrilled to
                  bring my knowledge and passion to all of you in the Valencian
                  Community and, why not, throughout Spain. I hope to share the
                  true flavor of Italian cuisine with you.
                </div>
              </Col>
            </>
          )}
            ...
            <>
              <Col className="col-12 col-lg-9 col-xxl-7 d-flex flex-column d-flex justify-content-center">
                ...
                <div className="ls-1">
                  ...
                  estado emocionado de compartir mi amor por la cocina. En mi
                  servicio, encontrarás la auténtica cocina italiana,
                  enriquecida por mi experiencia en España y Argentina. Todo
                  esto, servido con un toque de elegancia, en la comodidad de tu
                  hogar. He tenido la fortuna de trabajar en diversos lugares,
                  desde Italia hasta Irlanda y España. Me formé en la Escuela de
                  Hostelería de Sevilla, una de las mejores de España, y he
                  tenido el privilegio de aprender de chefs de renombre como
                  Rafa Zafra, Ricardo Acquista y Gonzalo Villalba. También con
                  Pasta Garófalo España generando recetas y videos desde hace
                  dos años, habiendo hecho más de 150 video-recetas. Me llena de
                  ilusión llevar mis conocimientos y mi pasión a todos ustedes
                  en la Comunidad Valenciana y, ¿por qué no?, en toda España.
                  Espero poder compartir el verdadero sabor de la cocina
                  italiana contigo.
                </div>
              </Col>
            </>
            ...
            <>
              <Col className="col-12 col-lg-9 col-xxl-7 d-flex flex-column d-flex justify-content-center">
                ...
                <div className="ls-1">
                  ...
                  questo è servito con un tocco di eleganza, nel comfort della
                  tua casa. Ho avuto la fortuna di lavorare in diversi luoghi,
                  dall
                  {"'"}
